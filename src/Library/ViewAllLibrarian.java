...
public class ViewAllLibrarian {
	...
	public ViewAllLibrarian() {
		String s = "select id,name,age,gender,mobno,address from librariandetails";
		columns = new String[]{"Id","Name","Age","Gender","Mobile No.","Address"};
